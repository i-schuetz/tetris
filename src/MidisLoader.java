...
/* MidisLoader  stores a collection of MidiInfo objects
 ...
 --------------------------------------------------------------------
 Changed by Schuetz - changed some code to allow pausing and resuming of whole loader(not just current track), 
 added Generics, changed formatting, removed some sysouts and comments.
 */
